 ...
 public class TestNGnew {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
		 ...
		 class TestNGExample extends BaseMethod{
			...
			public void Test2_ClickOnGetStartedButton() throws InterruptedException {
				...
				waitUntilElementDisplayed1(driver,getStarted);
				getStarted.click();
				Thread.sleep(5000);
	...
	public static void waitUntilElementDisplayed1(WebDriver driver, WebElement getStarted) {
		// TODO Auto-generated method stub
		
	}

	public static void waitUntilElementDisplayed(WebDriver driver, WebElement getStarted) {
		// TODO Auto-generated method stub
